...
<title>DPSaia:Variable Syntax: Chapter 2: Ex. Script 2.2</title>
...
<div class="container">
 ...
 <h4>Chapter 2: What Are Variables?</h4>  
  ...
  <article class="content">
    <section>
    <hr/>
    <h4>To create proper Variable Syntax follow these rules.</h4>



<p>2.2 This following was created by PHP. I have predefined each variable by assigning a value to each, and then used php print function to send info to browser page. It isn't neccessary to predefine a variable but it makes it clearer. Commenting each variable will also help make it easier to understand what the value means.
</p>
<p>
<?php // Script 2.2 -syntax-c2-2.2.php
